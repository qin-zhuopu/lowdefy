  ...
  properties: {
    ...
    properties: {
      ...
      localeSelector: {
        ...
        default: false,
        description:
          'Show a locale picker dropdown in the sider and mobile header. Lists locales declared in `config.i18n.locales` and dispatches `SetLocale` on selection. Renders nothing when `config.i18n` is not configured.',
      },
      iconsColor: {
        type: 'string',
